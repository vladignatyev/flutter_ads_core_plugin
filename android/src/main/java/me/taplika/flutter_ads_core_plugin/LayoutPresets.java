...
public class LayoutPresets {
    public static Map<String, NativeAdFactory> factories = new HashMap<String, NativeAdFactory>() {{
        ...
        put("large_media_top", new BasicNativeAd(R.layout.large_media_top, BasicNativeAd.TextMeasureVariant.full_width));
        put("large_media_top_tall", new BasicNativeAd(R.layout.large_media_top_tall, BasicNativeAd.TextMeasureVariant.full_width));
